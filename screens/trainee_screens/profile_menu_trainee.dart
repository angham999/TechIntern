...
import 'package:techintern_app_project/screens/trainee_screens/edit_profile_trainee.dart';

class ProfileMenuTraineeScreen extends StatefulWidget {
  const ProfileMenuTraineeScreen({Key? key}) : super(key: key);

  @override
  _ProfileMenuTraineeScreenState createState() => _ProfileMenuTraineeScreenState();
}

class _ProfileMenuTraineeScreenState extends State<ProfileMenuTraineeScreen> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: Column(
        ...
        children: [
          buildImageName(loggedInTrainee),
          buildEditButton(),
          const Divider(
              height: 80,
              thickness: 8,
  ...
  Widget buildImageName(Trainee user) => Padding(
  ...
  Widget buildEditButton() => Center(
        ...
        child: MaterialButton(
            ...
            minWidth: 170,
            onPressed: () {
              Navigator.of(context).push(MaterialPageRoute(builder: (BuildContext context) => const EditProfileTraineeScreen()));
            },
            child: const Text(
              "EDIT PROFILE",
